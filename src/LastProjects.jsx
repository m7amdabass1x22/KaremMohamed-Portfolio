import project1 from "./assets/vedios/mp4.mp4";
import project7 from "./assets/vedios/mp42.mp4";
import project4 from "./assets/vedios/IMG_9414.MP4";
import project2 from "./assets/vedios/ayhagategy.mp4";
      ...
      <div className="container  md:h-full  text-end  flex flex-col gap-10">
        <div className="w-full  flex-row-reverse flex justify-between animate__animated animate__fadeInLeft ">
          <div className=" flex flex-col gap-3 w-full md:w-[50%]  ">
            <h1 className=" w-full text-5xl md:text-8xl  font-bigest text-white">
              {" "}
              اخر الاعمال
            </h1>
            <p className=" md:text-baio font-arabic">
              مجموعه من المشاريع التي تعكس شغفي بالتميز في المنتاج و
              التصوير{" "}
            </p>
          </div>
        </div>
